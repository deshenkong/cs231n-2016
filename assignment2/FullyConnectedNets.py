...
#print 'TestinZg relu_forward function:'
#print 'difference: ', rel_error(out, correct_out)
#
...
#W1_std = abs(model.params['W1'].std() - std)#用来检测randn的标准正态分布值
#b1 = model.params['b1']
...
##用data喂给modle，根据update_rule来调参
#solver = Solver(model, data,                
#                lr_decay=0.95,                
#                print_every=122, num_epochs=40, batch_size=400, 
#                update_rule='sgd',                
...
#  [ 0.1248705,   0.17744702,  0.230602243,  0.28259667,  0.33516969],
